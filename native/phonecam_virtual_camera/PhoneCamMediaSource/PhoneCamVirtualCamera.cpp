...
{
    /////////////////////////////////////////////////////////////////////////////////
    HRESULT PhoneCamVirtualCamera::Initialize()
    {
    ...
    IFACEMETHODIMP PhoneCamVirtualCamera::BeginGetEvent(
    ...
    IFACEMETHODIMP PhoneCamVirtualCamera::EndGetEvent(
    ...
    IFACEMETHODIMP PhoneCamVirtualCamera::GetEvent(
            DWORD dwFlags,
            _COM_Outptr_ IMFMediaEvent** ppEvent
        )
    {
    ...
    IFACEMETHODIMP PhoneCamVirtualCamera::QueueEvent(
    ...
    IFACEMETHODIMP PhoneCamVirtualCamera::CreatePresentationDescriptor(
    ...
    IFACEMETHODIMP PhoneCamVirtualCamera::GetCharacteristics(
    ...
    IFACEMETHODIMP PhoneCamVirtualCamera::Pause()
    {
    ...
    IFACEMETHODIMP PhoneCamVirtualCamera::Shutdown()
    {
        winrt::slim_lock_guard lock(m_Lock);
    ...
    IFACEMETHODIMP PhoneCamVirtualCamera::Start(
    ...
    HRESULT PhoneCamVirtualCamera::_GetStreamDescriptorByStreamId(DWORD dwStreamId, DWORD* pdwStreamIdx, bool* pSelected, IMFStreamDescriptor** ppStreamDescriptor)
    {
    ...
    IFACEMETHODIMP PhoneCamVirtualCamera::Stop()
    {
        winrt::slim_lock_guard lock(m_Lock);
    ...
    // IMFMediaSourceEx
    IFACEMETHODIMP PhoneCamVirtualCamera::GetSourceAttributes(_COM_Outptr_ IMFAttributes** sourceAttributes)
    {
        winrt::slim_lock_guard lock(m_Lock);
    ...
    IFACEMETHODIMP PhoneCamVirtualCamera::GetStreamAttributes(
    ...
    IFACEMETHODIMP PhoneCamVirtualCamera::SetD3DManager(
    ...
    IFACEMETHODIMP PhoneCamVirtualCamera::GetService(
    ...
    // IKsControl methods
    _Use_decl_annotations_
    IFACEMETHODIMP PhoneCamVirtualCamera::KsProperty(
        ...
        )
    {
        ...
        // support controls.
        if ((pProperty->Set != PROPSETID_PhoneCamVirtualCamera_CUSTOMCONTROL) || (pProperty->Id >= KSPROPERTY_PhoneCamVirtualCamera_CUSTOMCONTROL_END))
        {
        ...
        if (pPropertyData == NULL && ulDataLength == 0)
        {
            ...
            switch (pProperty->Id)
            {
            case KSPROPERTY_PhoneCamVirtualCamera_CUSTOMCONTROL_COLORMODE:
                *pBytesReturned = sizeof(KSPROPERTY_PhoneCamVirtualCamera_CUSTOMCONTROL_COLORMODE_S);
                break;
        ...
        else
        {
            ...
            {
            case KSPROPERTY_PhoneCamVirtualCamera_CUSTOMCONTROL_COLORMODE:
                if (ulDataLength < sizeof(KSPROPERTY_PhoneCamVirtualCamera_CUSTOMCONTROL_COLORMODE_S))
                {
                ...
                if (0 != (pProperty->Flags & (KSPROPERTY_TYPE_SET)))
                {
                    ...
                    *pBytesReturned = 0;
                    ...
                    {
                        m_streamList[i]->SetRGBMask(((PKSPROPERTY_PhoneCamVirtualCamera_CUSTOMCONTROL_COLORMODE_S)pPropertyData)->ColorMode);
                        *pBytesReturned = sizeof(KSPROPERTY_PhoneCamVirtualCamera_CUSTOMCONTROL_COLORMODE_S);
                    }
                }
                // Get operation
                else if (0 != (pProperty->Flags & (KSPROPERTY_TYPE_GET)))
                {
                    ...
                    ((PKSPROPERTY_PhoneCamVirtualCamera_CUSTOMCONTROL_COLORMODE_S)pPropertyData)->ColorMode = m_streamList[0]->GetRGBMask();
                    *pBytesReturned = sizeof(KSPROPERTY_PhoneCamVirtualCamera_CUSTOMCONTROL_COLORMODE_S);
                }
                else
                {
    ...
    _Use_decl_annotations_
    IFACEMETHODIMP PhoneCamVirtualCamera::KsMethod(
    ...
    _Use_decl_annotations_
    IFACEMETHODIMP PhoneCamVirtualCamera::KsEvent(
    ...
    IFACEMETHODIMP PhoneCamVirtualCamera::SetDefaultAllocator(
    ...
    IFACEMETHODIMP PhoneCamVirtualCamera::GetAllocatorUsage(
        _In_  DWORD dwOutputStreamID,
    ...
    /// Internal methods.
    HRESULT PhoneCamVirtualCamera::_CheckShutdownRequiresLock()
    {
    ...
    HRESULT PhoneCamVirtualCamera::_ValidatePresentationDescriptor(_In_ IMFPresentationDescriptor* pPD)
    {
        DWORD cStreams = 0;
    ...
    HRESULT PhoneCamVirtualCamera::_CreateSourceAttributes()
    {
    ...
    HRESULT PhoneCamVirtualCamera::_GetMediaStreamById(_In_ DWORD dwStreamId, _COM_Outptr_ SimpleMediaStream** ppStream)
    {
