...
//
#pragma once
#ifndef PhoneCamVirtualCamera_H
#define PhoneCamVirtualCamera_H

// Example Custom Property implemented by PhoneCamVirtualCamera
// 
// {0CE2EF73-4800-4F53-9B8E-8C06790FC0C7}
static const GUID PROPSETID_PhoneCamVirtualCamera_CUSTOMCONTROL =
{ 0xce2ef73, 0x4800, 0x4f53, { 0x9b, 0x8e, 0x8c, 0x6, 0x79, 0xf, 0xc0, 0xc7 } };

enum
{
    KSPROPERTY_PhoneCamVirtualCamera_CUSTOMCONTROL_COLORMODE = 0,
    KSPROPERTY_PhoneCamVirtualCamera_CUSTOMCONTROL_END  // all ids must define before this.
};

#define KSPROPERTY_PhoneCamVirtualCamera_CUSTOMCONTROL_COLORMODE_GRAYSCALE        0x00FFFFFFL
#define KSPROPERTY_PhoneCamVirtualCamera_CUSTOMCONTROL_COLORMODE_RED              0x00FF0000L
#define KSPROPERTY_PhoneCamVirtualCamera_CUSTOMCONTROL_COLORMODE_GREEN            0x0000FF00L
#define KSPROPERTY_PhoneCamVirtualCamera_CUSTOMCONTROL_COLORMODE_BLUE             0x000000FFL

typedef struct {
    ULONG      StremID;
    ULONG      ColorMode;
} KSPROPERTY_PhoneCamVirtualCamera_CUSTOMCONTROL_COLORMODE_S, * PKSPROPERTY_PhoneCamVirtualCamera_CUSTOMCONTROL_COLORMODE_S;
...
namespace winrt::WindowsSample::implementation
{
    ...
    struct PhoneCamVirtualCamera : winrt::implements<PhoneCamVirtualCamera, IMFMediaSourceEx, IMFGetService, IKsControl, IMFSampleAllocatorControl>
    {
        PhoneCamVirtualCamera() = default;
