...
namespace winrt::WindowsSample::implementation
{
    ...
    {
        friend struct PhoneCamVirtualCamera;
    ...
    public:
        ...
        HRESULT Initialize(_In_ PhoneCamVirtualCamera* pSource, _In_ DWORD streamId, _In_ MFSampleAllocatorUsage allocatorUsage);
        HRESULT Start();
        HRESULT Stop();
        HRESULT Shutdown();
