...
//
#pragma once
#ifndef PhoneCamVirtualCameraACTIVATE_H
#define PhoneCamVirtualCameraACTIVATE_H

namespace winrt::WindowsSample::implementation
{
    struct __declspec(uuid("E807E3F3-AC55-490B-8371-56BC0C464978"))
        PhoneCamVirtualCameraActivate : winrt::implements<PhoneCamVirtualCameraActivate, IMFActivate>
    {
        PhoneCamVirtualCameraActivate() = default;
    ...
    private:
        ...
        winrt::com_ptr<winrt::WindowsSample::implementation::PhoneCamVirtualCamera> m_spSimpleMediaSrc;
    };
}
...
// cocreatable class
//
struct PhoneCamVirtualCameraActivateFactory : public winrt::implements<PhoneCamVirtualCameraActivateFactory, IClassFactory>
{
public:
    STDMETHODIMP CreateInstance(_In_ IUnknown*, _In_ REFIID riid, _COM_Outptr_ void** result) noexcept final try
    {
        ...
        *result = nullptr;
        ...
        winrt::com_ptr<winrt::WindowsSample::implementation::PhoneCamVirtualCameraActivate> ptr = winrt::make_self<winrt::WindowsSample::implementation::PhoneCamVirtualCameraActivate>();
